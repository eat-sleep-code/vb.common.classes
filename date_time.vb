...
Public Class date_time
	...
	Public Function timestamp(Optional unique_suffix As String = "000000") As String
		...
		Return Right("0000" + seed.Year.ToString, 4) + seed.Month.ToString("0#") + seed.Day.ToString("0#") + seed.Hour.ToString("0#") + seed.Minute.ToString("0#") + seed.Second.ToString("0#") + Left(seed.Millisecond.ToString + "0000", 4) + Right("000000" + unique_suffix, 6)
	End Function
